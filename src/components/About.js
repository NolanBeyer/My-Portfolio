    ...
    <div className="about">
      <div className="about__body">
        ...
        <h4 className="about__description">
          ...
          HTML and CSS. I fell in love with the thought of making this a full
          time career. I've spent countless hours over the last year and
          although I still have a lot to learn I'm really excited for this next
          step and am willing to learn additional technologies to fit the needs
          of future employers.
        </h4>
        <div className="work">
        ...
        <div className="work">
          <div className="work__history">
            ...
            <h4 className="work__description">
              Designed graphics for various buisnesess using adobe illustrator.
            </h4>
          </div>
        </div>
      </div>
